# Manual de Implementação do CQRS
...
| **Manipulador de Comandos** | Valida e executa comandos |

| **Evento** | Registro de alteração de estado |

| **Consulta** | Solicitação de dados |

| **Manipulador de Consultas** | Recupera dados do modelo lido |

| **Projetor** | Atualiza o modelo lido a partir de eventos |
...
- **Separe os modelos de comando e consulta** - Necessidades diferentes
- **Use consistência eventual** - Aceite o atraso de propagação
- **Valide nos manipuladores de comando** - Antes da mudança de estado
- **Desnormalize os modelos de leitura** - Otimize para consultas
- **Versione seus eventos** - Para a evolução do esquema

### Recomendações a Não Fazer

- **Não consulte em comandos** - Use apenas para gravações
- **Não acople esquemas de leitura/gravação** - Evolução independente
- **Não complique demais** - Comece com algo simples
- **Não ignore os SLAs de consistência** - Defina um atraso aceitável

## Recursos

- [Padrão CQRS](https://martinfowler.com/bliki/CQRS.html)
- [Diretrizes do Microsoft CQRS](https://docs.microsoft.com/en-us/azure/architecture/patterns/cqrs)			